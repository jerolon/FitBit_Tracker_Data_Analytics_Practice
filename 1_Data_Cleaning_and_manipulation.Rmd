...
We discard duplicates check there is only one record per date per Id. We filter out any record with fewer than 15 SedentaryMinutes. It is hard to think of someone who had no rest at all during the day. Conversely, I get rid of all days with more than (1440-15) sedentary minutes, (1440 is the total number of minutes in a day).
